...
from players import RandomAgent, Rollout
...
class getAwayGUI:
        ...
        while pygame_on and num_live_players>1:
            ...
            while num_live_players>1:
                ...
                while i<num_live_players and (not round_end_early):
                    ...
                    table_cards.pick_up_card( current.getAway_move(table_cards) )
    ...
    def display_loser(self):
        ...
        while not quit:
            ...
            text = my_font.render(f"{lost} couldn't get away!", True, (255,255,255))
...
def get_players():
    ...
    for i in range(4):
        ...
        if selection==1:
            ...
            players[i] = BasePolicy(name=names[i])
        else:
...
def main():
    ...
    loser_count = {}
    game = getAwayGUI( all_players, loser_count )
    game.run_game()
